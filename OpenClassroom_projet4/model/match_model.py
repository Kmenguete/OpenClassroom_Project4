...
class Match:
    ...
    def display_match(self):
        ...
        print(
            "Match: "
            + self.player_a.firstname
            + " "
            + self.player_a.last_name
            + " vs "
            + self.player_b.firstname
            + " "
    ...
    def get_match_id(match_id):
        """The get_match_id method return the match_id of every match."""
        if match_id is None:
    ...
    def __str__(self):
        ...
        return (
            ...
            + str(self.player_a)
            + ", score: "
            + str(self.score_player_a)
            + " vs "
            + str(self.player_b)
            + ", score: "
            + str(self.score_player_b)
        )

...
class View:
    ...
    def display_match_information(match):
        ...
        return (
            "Match: "
            + match.player_a.firstname
            + " "
            + match.player_a.last_name
            + " vs "
            + match.player_b.firstname
            + " "
    ...
    def get_tournament_id():
        """The get_tournament_id method asks the user to select a tournament by his id in the report menu."""

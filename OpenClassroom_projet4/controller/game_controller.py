...
class GameController:
    ...
    def run_game(self):
        """ The run game method call every methods that let to run, save and update the tournament.
                    """
    ...
    def create_tournament(self):
        """ The create tournament method let the user to create a tournament.
                            """
    ...
    def create_players(self):
        """ The create players method let the user to create players.
                                    """
        player_list = []
    ...
    def render_all_matches(self):
        """ The render all matches method is called every where we need to display matches in order to know which
        players has to meet each other in a given round.
                                            """
    ...
    def get_initial_round_results_and_update(self, round_name="Round 1"):
        """ When a match is finished, the user enter the result. the user repeat the process for every matches

...
class MainController:
    ...
    def save_data(self):
        self.database.save_tournament_data(self.tournament_service.tournament, 'tournament_database.pickle')
        self.database.save_players_data(self.tournament_service.tournament.players, 'players_database.pickle')
        self.database.save_rounds_data(self.tournament_service.tournament.rounds, 'rounds_database.pickle')

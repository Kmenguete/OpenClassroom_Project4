...
class TournamentService:
    ...
    def update_tournament(self, name, place, date, description, number_of_rounds):
        ...
        self.tournament_table.save_tournament(self.tournament)
    ...
    def create_first_round(self, match_list, round_id):
        ...
        self.round_table.save_round(first_round)
        self.round_table.save_rounds(self.tournament.rounds)
    ...
    def create_next_round(self, round_number, match_list, round_id):
        ...
        self.round_table.save_round(next_round)
        self.round_table.save_rounds(self.tournament.rounds)
        return next_round

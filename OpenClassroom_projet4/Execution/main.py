        ...
        while True:
            ...
            if winner != 'A' and winner != 'B' and winner != 'None':
                ...
                if winner == 'A':
                    ...
                    tournament.seek_player_and_update_score(match.player_a.rank, match.score_player_a)
                    tournament.seek_player_and_update_score(match.player_b.rank, match.score_player_b)
                break

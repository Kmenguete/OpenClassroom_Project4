...
class Round:
    def __init__(self, name_of_tournament, round_number, match_number, player_1, player_2, score_player_1, score_player_2):
    ...
    def __str__(self):
        return self.name_of_tournament + " " + self.round_number + " " + self.match_number + " " + self.player_1 + " " \
               + self.player_2 + " " + self.score_player_1 + " " + self.score_player_2
...
if __name__ == '__main__':
    ...
    round = Round(name_of_tournament, round_number, match_number, player_1, player_2, score_player_1,
                  score_player_2)
    ...
    round_database.insert({'player_1': player_1})
    round_database.insert({'player_2': player_2})
    round_database.insert({'score_player_1': score_player_1})
    round_database.insert({'score_player_2': score_player_2})

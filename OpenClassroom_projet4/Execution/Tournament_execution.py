...
if __name__ == '__main__':
    ...
    tournament_database.insert({'name_of_tournament': name_of_tournament})
    tournament_database.insert({'place_of_tournament': place_of_tournament})
    tournament_database.insert({'date_of_tournament': date_of_tournament})
    tournament_database.insert({'duration_of_tournament': duration_of_tournament})
    tournament_database.insert({'number_of_round': number_of_round})
    tournament_database.insert({'number_of_match': number_of_match})
    tournament_database.insert({'description_of_tournament': description_of_tournament})

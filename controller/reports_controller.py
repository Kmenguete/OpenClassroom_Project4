...
class ReportsController:
    """The Report controller aim to manage the reports requested by the user."""

    def __init__(self):
        """The init method import every module required for the reports."""
    ...
    def another_report_suggestion(self):
        ...
        while True:
            ...
            if choice == "Yes":
                ...
                View.display_text(
                    "Invalid answer. You should answer the question by Yes or No"
                )

    def manage_report_choice_1(self):
        """If the user choose the question 1, the report service will display the list of every player of every
    ...
    def manage_report_choice_2(self):
        """If the user choose the question 2, the report service will display the list of every player of every
    ...
    def manage_report_choice_3(self):
        """If the user choose the question 3, the report service will display the list of every tournament."""
        while True:
    ...
    def manage_report_choice_4(self):
        """If the user choose the question 4, the report service will display the list of every player for a
        ...
        while True:
            ...
            try:
                players = (
                    self.report_service.get_tournament_players_in_alphabetical_order(
                        tournament_id
                    )
                )
                View.display_players(players)
    ...
    def manage_report_choice_5(self):
        """If the user choose the question 5, the report service will display the list of every player for a
        ...
        while True:
            ...
            tournament_id = View.get_tournament_id()
            try:
                players = self.report_service.get_tournament_players_sorted_by_rank(
                    tournament_id
                )
                View.display_players(players)
                self.another_report_suggestion()
    ...
    def manage_report_choice_6(self):
        """If the user choose the question 6, the report service will display the list of every round for a specific
        tournament.
        """
        while True:
            self.tournament_table.display_tournaments()
    ...
    def manage_report_choice_7(self):
        """If the user choose the question 7, the report service will display the list of every match for a specific
        tournament.
        """
        while True:
            self.tournament_table.display_tournaments()
